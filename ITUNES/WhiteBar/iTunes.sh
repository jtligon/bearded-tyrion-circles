		...
		then
			...
			then
				...
				then			    
					...
					$convert -size 700x300  xc:transparent -stroke none -fill White -draw "fill-opacity 0.5 arc 421,210 541,90 -90,90" -fill White -draw "fill-opacity 0.5 rectangle 120,210 480,90" $img
					#$convert -size 700x300  xc:transparent -stroke none -fill White -draw "fill-opacity 0.5 arc 471,260 691,40 -90,90" -fill White -draw "fill-opacity 0.5 rectangle 120,260 580,40" $img 
